...
import eu.gloria.rt.entity.device.OpState;
...
import eu.gloria.rtc.ExecutorControl;
...
public class GloriaRtiImpl implements GloriaRti {
	...
	public java.util.List<java.lang.Double> camGetObjectExposureTime(java.lang.String session,java.lang.String deviceId,java.lang.String object,java.lang.String filterType) throws RtiError    { 
        LOG.info("Executing operation camGetObjectExposureTime");
		...
		CameraControl dev = new CameraControl();
		try {
			return dev.camGetObjectExposureTime(deviceId, filterType, object);
		} catch (Exception e) {
			throw RtiExceptionFactory.getRtiException(e);
		}
    }
	...
	public java.util.List<java.lang.String> camGetFilterWheels(java.lang.String session,java.lang.String deviceId) throws RtiError    { 
		
		LogUtil.info(this, "Executing operation camGetFilterWheels");
		validateSession(session);

		CameraControl dev = new CameraControl();
		try {
			return dev.camGetFilters(deviceId);
		} catch (Exception e) {
			throw RtiExceptionFactory.getRtiException(e);
		}
    }
	...
	public java.lang.String execStartOp(java.lang.String session,java.lang.String uuidOp,java.lang.String user,long seconds) throws RtiError    {
		
		LogUtil.info(this, "Executing operation execStartOp");
		
		validateSession(session);
		
		try {
			
			ExecutorControl dev = new ExecutorControl();
			return dev.start(uuidOp, user, seconds);
	...
	public boolean mntIsPointingAtCoordinates(java.lang.String session,java.lang.String deviceId,double ra,double dec,double raError,double decError) throws RtiError    {
		
		LogUtil.info(this, "Executing operation mntIsPointingAtCoordinates");
		validateSession(session);

		MountControl dev = new MountControl();
		try {
			return dev.mntIsPointingAtCoordinates(deviceId, ra, dec, raError, decError);
		} catch (Exception e) {
			throw RtiExceptionFactory.getRtiException(e);
		}
    }
	...
	public eu.gloria.rt.entity.device.ExecutorInfo execGetInfo(java.lang.String session) throws RtiError    { 
		
		LogUtil.info(this, "Executing operation execGetInfo");
		...
		try {
			...
			ExtExecInfo internalInfo = dev.getExtExecInfo();
			
			ExecutorInfo result = new ExecutorInfo();
			result.setState(ExecutorState.fromValue(internalInfo.getState().toString()));
			result.setUuidOp(internalInfo.getUuidOp());
			result.setDescription(internalInfo.getDescription());
	...
	public boolean mntIsPointingAtObject(java.lang.String session,java.lang.String deviceId,java.lang.String object,double raError,double decError) throws RtiError    { 
		LogUtil.info(this, "Executing operation mntIsPointingAtObject");
		validateSession(session);

		MountControl dev = new MountControl();
		try {
			return dev.mntIsPointingAtObject(deviceId, object, raError, decError);
		} catch (Exception e) {
			throw RtiExceptionFactory.getRtiException(e);
		}
    }
	...
	public java.lang.String camGetFocuser(java.lang.String session,java.lang.String deviceId) throws RtiError    { 
		
		LogUtil.info(this, "Executing operation camGetFocuser");
		validateSession(session);

		CameraControl dev = new CameraControl();
		try {
			return dev.camGetFocuser(deviceId);
		} catch (Exception e) {
			throw RtiExceptionFactory.getRtiException(e);
		}
    }
...
//			return null;
	...
	public long focGetMinStep(java.lang.String session,java.lang.String deviceId) throws RtiError    { 
        LOG.info("Executing operation focGetMinStep");
        validateSession(session);

		FocuserControl dev = new FocuserControl();
		try {
			return dev.focGetMinStep(deviceId);
		} catch (Exception e) {
			throw RtiExceptionFactory.getRtiException(e);
		}
    }
	...
	public eu.gloria.rt.entity.device.OpInfo execGetLastOpInfo(java.lang.String session) throws RtiError    { 
		
		LogUtil.info(this, "Executing operation execGetLastOpInfo");
		...
		try {
			...
			OpInfo internalInfo = dev.getLastOpInfo();
			eu.gloria.rt.entity.device.OpInfo result = null;
			
			if (internalInfo != null){
				result = new eu.gloria.rt.entity.device.OpInfo();
				result.setDescription(internalInfo.getDesc());
				result.setDuration(internalInfo.getDuration());
				result.setState(OpState.fromValue(internalInfo.getState().toString()));
				result.setUser(internalInfo.getUser());
				result.setUuidOp(internalInfo.getUuid());
			}
	...
	public void execStopOp(java.lang.String session) throws RtiError    { 
		
		LogUtil.info(this, "Executing operation execStopOp");
